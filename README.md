...
```
curl -fsSL "https://github.com/neiromaster/tmux/raw/refs/heads/master/install.sh#$(date +%s)" | bash
```

**Manual installation in `~`**
```
$ cd
$ git clone --single-branch https://github.com/neiromaster/tmux.git
$ cd tmux
...
```shell
$ git clone --single-branch https://github.com/neiromaster/tmux.git /path/to/oh-my-tmux
